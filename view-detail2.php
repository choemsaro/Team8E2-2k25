...
<body>
    ...
    <div class="container123" id="view1">
        <div class="box-detail">
            <br>
            <div class="image1">
                <img src="/img/cycle/angkor9.png" alt="" style="width: 100%; height: 470px;">
        ...
        <div class="box-detail">
            <br>
            <div class="image1">
                <img src="/img/cycle/c1.png" alt="" style="width: 100%; height: 400px; ">
                <div class="image-text1">
                    ក្នុងប្រសាទតែម្តងទេសភាពស្អាតការទាក់ទាញអោយភ្ញៀវនៅក្រៅនិងក្នុងប្រទេសមកទស្សនានាថ្ងៃលិចយ៉ាងច្រើនកុះករមិនតែប៉ុន្នោះប្រទេសកម្ពុជាជាប់ចំណាត់ថ្នាក់លេខ១ដែលមានទេសភាពថ្ងៃលិចស្អាចជាងគេ
                </div>
            </div>
            <div class="detail1">
                <div class="imgage-left">
                    <img src="/img/cycle/s1.png" alt="">
                    <div class="image-text">ប្រាសាទអង្គរវត្តថតរូបជុំគ្នា</div>
                </div>
                <div class="imgage-right">
                    <img src="/img/cycle/c2.png" alt="">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="property-item rounded overflow-hidden">
                        ...
                        <div class="d-flex border-top">
                            ...
                            </script><a class="flex-fill text-center border-end py-2 text-decoration-none">
